      ...
      <div className="min-h-screen bg-[#121212] text-white flex items-center justify-center p-4">
        <div className="bg-[#1E1E1E] border border-[#333333] p-8 rounded-xl w-full max-w-md shadow-2xl relative group">
          ...
          <div className="relative z-10 text-center">
            <img src="logo.png" alt="Famguard Logo" className="w-20 h-20 mx-auto mb-4 drop-shadow-[0_0_15px_rgba(234,179,8,0.3)]" />
      ...
      <div className="min-h-screen bg-[#121212] text-white p-6 flex flex-col items-center">
        <header className="w-full max-w-4xl flex justify-between items-center mb-12">
          <div className="flex items-center gap-3 text-xl font-bold">
            <img src="logo.png" alt="Famguard Logo" className="w-8 h-8" /> 
            Famguard
          </div>
      ...
      <div className="w-full max-w-5xl">
        <header className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-3 text-2xl font-bold">
            <img src="logo.png" alt="Famguard Logo" className="w-10 h-10" /> 
            Famguard
          </div>
          <div className="flex items-center gap-4">
